...
ARG VITE_OONLY_OFFICE_TOKEN=""
ARG VITE_OONLY_OFFICE_SERVER_URL=""
...
RUN VITE_ONLY_OFFICE_ID=${VITE_ONLY_OFFICE_ID} \
    VITE_OONLY_OFFICE_TOKEN=${VITE_OONLY_OFFICE_TOKEN} \
    VITE_OONLY_OFFICE_SERVER_URL=${VITE_OONLY_OFFICE_SERVER_URL} \
