...
| `coverFallbackSrc`     | `string`                                                                                 | `undefined`                         | 封面图片加载失败时显示的地址，`coverLazy`为`false`时有效                                                                                                         |
| `coverFallbackIcon`    | `Component`                                                                              | `Image(@vicons/ionicons5)`          | 封面图片加载失败时显示的图标组件（源自[`Naive UI Icon`](https://www.naiveui.com/zh-CN/os-theme/components/icon#Icon-Props)的`component`属性），`coverLazy`为`false`时有效 |
| `coverPlaceholderSrc`  | `string`                                                                                 | `undefined`                         | 封面图片加载中显示的地址，`coverLazy`为`true`时有效                                                                                                            |
| `coverPlaceholderIcon` | `Component`                                                                              | `Image(@vicons/ionicons5)`          | 封面图片加载中显示的图标组件（源自[`Naive UI Icon`](https://www.naiveui.com/zh-CN/os-theme/components/icon#Icon-Props)的`component`属性），`coverLazy`为`true`时有效    |
...
| `card-header`       | `(fileItem: FileItem)`   | 文件卡片头部内容（源自[`Naive UI Card`](https://www.naiveui.com/zh-CN/os-theme/components/card#Card-Slots)的`header`插槽），类型参考[FileItem](#fileitem)         |
| `card-header-extra` | `(fileItem: FileItem)`   | 文件卡片头部额外内容（源自[`Naive UI Card`](https://www.naiveui.com/zh-CN/os-theme/components/card#Card-Slots)的`header-extra`插槽），类型参考[FileItem](#fileitem) |
| `card-cover`        | `(fileItem: FileItem)`   | 文件卡片封面内容（源自[`Naive UI Card`](https://www.naiveui.com/zh-CN/os-theme/components/card#Card-Slots)的`cover`插槽），类型参考[FileItem](#fileitem)          |
| `card-footer`       | `(fileItem: FileItem)`   | 文件卡片标底部内容（源自[`Naive UI Card`](https://www.naiveui.com/zh-CN/os-theme/components/card#Card-Slots)的`footer`插槽），类型参考[FileItem](#fileitem)        |
| `card-action`       | `(fileItem: FileItem)`   | 文件卡片操作区域左侧内容（源自[`Naive UI Card`](https://www.naiveui.com/zh-CN/os-theme/components/card#Card-Slots)的`action`插槽），类型参考[FileItem](#fileitem)     |
| `card-action-extra` | `(fileItem: FileItem)`   | 文件卡片操作区域左侧额外内容（与`action`插槽互斥），类型参考[FileItem](#fileitem)                                                                                       |
| `card-action-right` | `(fileItem: FileItem)`   | 文件卡片操作区域右侧内容（与`action`插槽互斥），类型参考[FileItem](#fileitem)                                                                                         |
| `card-default`      | `(fileItem: FileItem)`   | 文件卡片内容（源自[`Naive UI Card`](https://www.naiveui.com/zh-CN/os-theme/components/card#Card-Slots)的`default`插槽），类型参考[FileItem](#fileitem)          |
...
| [`VideoViewer`](#videoviewer)       | `video/`(`mp4`, `webm`), `application/x-mpegURL`, `application/vnd.apple.mpegurl`, `application/dash+xml`                                                                                                                                                                                                      | `视频`预览组件。         |
...
| `lang`                | `string`                                  | `"zh"`                                               | [`OnlyOffice`语言配置](https://api.onlyoffice.com/zh-CN/docs/docs-api/usage-api/config/editor/#lang)                                      |
